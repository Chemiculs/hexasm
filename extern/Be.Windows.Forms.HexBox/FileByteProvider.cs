...
namespace Be.Windows.Forms
{
	...
	public class FileByteProvider : IByteProvider, IDisposable
	{
		...
		public List<HexAction> undo_actions_ { get; set;}
		public List<HexAction> redo_actions_ { get; set;}
		...
		public byte[] ReadBytes(long offset, long size)
		{
			...
			{
				if (_writes.Contains(i))
				{
					buffer[i - offset] = _writes[i];
				}
			}
